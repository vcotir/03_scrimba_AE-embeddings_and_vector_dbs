/*
    Objective: Create a conversational response using OpenAI
*/

import { openai, supabase } from "./config.js";

// User query about podcasts
const query = "please suggest some episodes about diving into eating food";
main(query);
...
async function getChatCompletion(text, query) {
  ...
  const response = await openai.chat.completions.create({
    ...
    temperature: 0.5, // balance between creativity and predictability
    frequency_penalty: 0.5, // Punishes model repetition
  });
