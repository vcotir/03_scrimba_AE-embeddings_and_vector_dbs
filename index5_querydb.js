/*
    Objective: Creates query emedding, do semantic search against DB, leverage compleitions and semantic results to get suggestions for movies
*/
import { openai, supabase } from "./config.js";

// Query about our movie data
const query = "I feel like an adrenaline rush";
main(query);
...
async function main(input) {
    try {
        ...
        console.error('Issue in main function: ', err.message)
        throw new Error(err)
    }
}
